      ...
      <div className="container mx-auto px-4">
        ...
        >
          <p className="text-lg mb-6">
            At BambooChic, sustainability isn't just a buzzword—it's at the core of everything we do. From our material choices to our manufacturing processes, we're committed to creating fashion that looks good, feels good, and does good for the planet.
          </p>
          ...
          <div className="relative h-[400px] mb-8 rounded-lg overflow-hidden">
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent flex items-end">
              <p className="text-white p-6 text-xl">Our sustainable bamboo is grown without pesticides or chemical fertilizers</p>
            </div>
          </div>
        </motion.div>
              ...
              <CardBody className="p-6">
                ...
                <ul className="space-y-3">
                  <li className="flex items-start gap-2">
                    ...
                    <div>
                      <span className="font-medium">Bamboo-derived fabrics</span> that require 1/3 the water of cotton and grow without pesticides or fertilizers
                    </div>
                  </li>
                  <li className="flex items-start gap-2">
                    <Icon icon="lucide:check-circle" className="text-primary mt-1" />
                    <div>
                      <span className="font-medium">Organic cotton</span> grown without harmful chemicals that damage soil and water systems
                    </div>
                  </li>
                  <li className="flex items-start gap-2">
                    <Icon icon="lucide:check-circle" className="text-primary mt-1" />
                    <div>
                      <span className="font-medium">Recycled materials</span> including polyester made from plastic bottles and regenerated cotton
                    </div>
                  </li>
                </ul>
              </CardBody>
              ...
              <CardBody className="p-6">
                ...
                <ul className="space-y-3">
                  <li className="flex items-start gap-2">
                    <Icon icon="lucide:check-circle" className="text-primary mt-1" />
                    <div>
                      <span className="font-medium">Fair wages</span> for all workers in our supply chain
                    </div>
                  </li>
                  <li className="flex items-start gap-2">
                    <Icon icon="lucide:check-circle" className="text-primary mt-1" />
                    <div>
                      <span className="font-medium">Safe working conditions</span> with regular third-party audits
                    </div>
                  </li>
                  <li className="flex items-start gap-2">
                    <Icon icon="lucide:check-circle" className="text-primary mt-1" />
                    <div>
                      <span className="font-medium">Water-saving techniques</span> that reduce manufacturing impact by up to 80%
                    </div>
                  </li>
                </ul>
              </CardBody>
