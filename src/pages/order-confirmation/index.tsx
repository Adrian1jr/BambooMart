        ...
        >
          <Card>
            <CardBody className="p-8 text-center">
              ...
              <div className="space-y-4 mb-8">
                <p>
                  We'll send you shipping confirmation and tracking information once your
                  order is on the way.
                </p>
          ...
          <div className="mt-8 text-center">
            <h2 className="text-xl font-bold mb-4">
              Thank You for Shopping with BambooMart!
            </h2>
            ...
            <div className="flex justify-center gap-4">
              ...
              <Button isIconOnly variant="flat" aria-label="Share on Instagram">
