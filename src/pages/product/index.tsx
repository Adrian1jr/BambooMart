...
const ProductPage: React.FC = () => {
  ...
  // Get the current main image to display
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
          ...
          >
            <div className="sticky top-24">
              <img 
                src={`https://img.heroui.chat/image/${currentImage}`}
                alt={product.name}
                className="w-full h-auto rounded-lg object-cover aspect-[3/4]"
              />
              <div className="grid grid-cols-4 gap-2 mt-4">
                {(product.images || [product.image, product.image, product.image, product.image]).map((image, index) => (
                  <div 
                    key={index} 
                  ...
                  >
                    <img 
                      src={`https://img.heroui.chat/image/${image}`}
