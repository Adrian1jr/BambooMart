            ...
            <CardBody className="p-6">
              <div className="space-y-6">
                <section>
                  ...
                  <p>
                    Welcome to BambooMart. These Terms of Service ("Terms") govern your
                    use of our website BambooMart.com (the "Website") and the products and
                    services offered through our Website (collectively, the "Services").
                  </p>
                  <p className="mt-2">
                ...
                <section>
                  ...
                  <p>
                    ...
                    to purchase the products you have selected based on these Terms. We
                  ...
                  <p className="mt-2">
                    ...
                    Prices are subject to change without notice. We make every effort to
                    ensure the accuracy of prices and product information, but errors may
                    occur. We reserve the right to correct any errors and to cancel any
                    orders where such an error has occurred.
                  </p>
                </section>
                ...
                <section>
                  ...
                  <p>
                    Shipping times and costs are provided during the checkout process. We
                    are not responsible for delays due to customs processing, weather
                ...
                <section>
                  ...
                  <p>
                    ...
                    <Link to="/shipping-returns" className="text-primary underline">
                ...
                <section>
                  ...
                  <p>
                    ...
                    owned by BambooMart and are protected by international copyright,
                    trademark, patent, trade secret, and other intellectual property or
                    proprietary rights laws.
                  </p>
                  <p className="mt-2">
                    You may not use, reproduce, distribute, modify, create derivative
                    works of, publicly display, publicly perform, republish, download, or
                    transmit any of the material on our Website without our prior written
                    consent.
                  </p>
                </section>
                ...
                <section>
                  ...
                  <p>
                    By posting, uploading, or otherwise making available any content on
                    our Website (e.g., product reviews, comments), you grant us a
                  ...
                  <p className="mt-2">
                    ...
                    the content you post, and that such content does not violate these
                ...
                <section>
                  ...
                  <ul className="list-disc pl-5 mb-3 space-y-1">
                    ...
                    <li>
                      To impersonate or attempt to impersonate BambooMart, a BambooMart
                ...
                <section>
                  ...
                  <p className="mt-2">
                    ...
                    errors or viruses. You are responsible for configuring your technology
                    to access the Website and should use your own virus protection
                    software.
                  </p>
                </section>
                ...
                <section>
                  ...
                  <p className="uppercase font-medium">
                    TO THE MAXIMUM EXTENT PERMITTED BY LAW, BambooMart SHALL NOT BE LIABLE
                ...
                <section>
                  ...
                  <p>
                    You agree to defend, indemnify, and hold harmless BambooMart, its
                ...
                <section>
                  ...
                  <p>
                    ...
                    current version will always be posted on the Website, with the "Last
                    Updated" date at the top of the page. Your continued use of the
                ...
                <section>
                  ...
                  <p>
                    ...
                    laws of the State of Oregon, without regard to its conflict of law
                    provisions.
                  </p>
                  <p className="mt-2">
                ...
                <section>
                  ...
                  <div className="mt-2">
                    ...
                    <p>United States</p>
                    <p className="mt-2">Email: legal@BambooMart.com</p>
