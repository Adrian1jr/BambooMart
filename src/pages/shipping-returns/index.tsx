  ...
  return (
    <div className="py-8">
      <div className="container mx-auto px-4">
        ...
        >
          We want to make your shopping experience as smooth as possible. Learn about our
          shipping options and return policy below.
        </motion.p>
        ...
        >
          <Card>
            <CardBody className="p-0">
              <Tabs
                aria-label="Shipping and Returns options"
                color="primary"
                variant="underlined"
              >
                <Tab
                    ...
                    <div className="space-y-8">
                      <div>
                        ...
                        <div className="overflow-x-auto">
                          <table className="min-w-full">
                            ...
                            <tbody>
                              <tr>
                                <td className="py-2 px-4 border border-divider">
                                  Standard Shipping
                                </td>
                                <td className="py-2 px-4 border border-divider">
                                  3-5 business days
                      ...
                      <div>
                        ...
                        <p className="mb-4">
                          ...
                          weekends and holidays). Once processed, your order will ship
                          according to the selected method.
                        </p>
                        <div className="flex items-center gap-2 text-success">
                          <Icon icon="lucide:package" />
                          <span>
                            Orders placed before 12 PM EST typically ship the same day.
                          </span>
                        </div>
                      </div>
                      ...
                      <div>
                        ...
                        <p className="mb-4">
                          ...
                          email with a tracking number. You can track your package at any
                          time through your account or by clicking the tracking link in
                          the email.
                        </p>
                      ...
                      <div>
                        ...
                        <p>
                          At BambooMart, we're committed to reducing our carbon footprint.
                          All our packaging is made from recycled materials and is 100%
                          recyclable or compostable. Additionally, we offset the carbon
                          emissions from all our deliveries.
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="space-y-8">
                      <div>
                        ...
                        <p>
                          ...
                          satisfied with your purchase. If you're not happy with your
                          order for any reason, we accept returns within 30 days of
                      ...
                      <div>
                        ...
                        <ul className="list-disc pl-5 space-y-2">
                          ...
                          <li>
                            Sale items marked as "Final Sale" cannot be returned or
                            exchanged
                          </li>
                          <li>
                            Undergarments and face masks cannot be returned for hygienic
                            reasons
                          </li>
                        </ul>
                      </div>
                      ...
                      <div>
                        ...
                        <p>
                          ...
                          our team to process it. Refunds are issued to the original
                          payment method and may take an additional 2-5 business days to
                      ...
                      <div>
                        ...
                        <p>
                          ...
                          customer service team within 7 days of receipt. We'll make it
