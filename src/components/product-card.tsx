        ...
        <CardFooter className="flex flex-col items-start text-left flex-1 w-full">
          ...
          <div className="w-full flex justify-between items-center mt-auto">
            <div className="flex items-center gap-2">
              {product.sale ? (
                <>
                  <span className="text-danger font-medium">${product.salePrice?.toFixed(2)}</span>
                  <span className="text-default-500 text-small line-through">${product.price.toFixed(2)}</span>
                </>
              ) : (
